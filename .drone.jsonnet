...
[
  ...
  pipeline.build(name, 'v4.5', '4.5', 'amd64'),
  pipeline.build(name, 'v4.5', '4.5', 'arm32v6'),
  pipeline.build(name, 'v4.5', '4.5', 'arm64v8'),
  pipeline.manifest('v4.5', '4.5', ['amd64', 'arm32v6', 'arm64v8']),
  ...
  pipeline.microbadger(['latest', '4.5', '2.5']),
]
