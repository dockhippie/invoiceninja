...
class Carbon extends DateTime
{
    ...
    public static function setLocale($locale)
    {
        ...
        static::translator()->addResource('array', require '/srv/www/vendor/nesbot/carbon/src/Carbon' . '/Lang/' . $locale . '.php', $locale);
    }
...
class AppServiceProvider extends ServiceProvider
{
    public function boot()
    {
        ...
        HTML::macro('emailViewButton', function ($link = '#', $entityType = ENTITY_INVOICE) {
            return view('partials.email_button')->with(array('link' => $link, 'field' => "view_{$entityType}", 'color' => '#0b4d78'))->render();
        });
        HTML::macro('emailPaymentButton', function ($link = '#') {
            return view('partials.email_button')->with(array('link' => $link, 'field' => 'pay_now', 'color' => '#36c157'))->render();
        });
        ...
        Validator::extend('valid_contacts', function ($attribute, $value, $parameters) {
            foreach ($value as $contact) {
                $validator = Validator::make($contact, array('email' => 'email|required_without:first_name', 'first_name' => 'required_without:email'));
                if ($validator->fails()) {
                    return false;
                }
            }
    ...
    public function register()
    {
        ...
        $this->app->bind('App\\Ninja\\Import\\DataImporterServiceInterface', 'App\\Ninja\\Import\\FreshBooks\\FreshBooksDataImporterService');
    }
}
}
...
class EventServiceProvider extends ServiceProvider
{
    protected $listen = array('App\\Events\\ClientWasCreated' => array('App\\Listeners\\ActivityListener@createdClient', 'App\\Listeners\\SubscriptionListener@createdClient'), 'App\\Events\\ClientWasArchived' => array('App\\Listeners\\ActivityListener@archivedClient'), 'App\\Events\\ClientWasDeleted' => array('App\\Listeners\\ActivityListener@deletedClient'), 'App\\Events\\ClientWasRestored' => array('App\\Listeners\\ActivityListener@restoredClient'), 'App\\Events\\InvoiceWasCreated' => array('App\\Listeners\\ActivityListener@createdInvoice', 'App\\Listeners\\SubscriptionListener@createdInvoice', 'App\\Listeners\\InvoiceListener@createdInvoice'), 'App\\Events\\InvoiceWasUpdated' => array('App\\Listeners\\ActivityListener@updatedInvoice', 'App\\Listeners\\InvoiceListener@updatedInvoice'), 'App\\Events\\InvoiceWasArchived' => array('App\\Listeners\\ActivityListener@archivedInvoice'), 'App\\Events\\InvoiceWasDeleted' => array('App\\Listeners\\ActivityListener@deletedInvoice', 'App\\Listeners\\TaskListener@deletedInvoice'), 'App\\Events\\InvoiceWasRestored' => array('App\\Listeners\\ActivityListener@restoredInvoice'), 'App\\Events\\InvoiceWasEmailed' => array('App\\Listeners\\NotificationListener@emailedInvoice'), 'App\\Events\\InvoiceInvitationWasEmailed' => array('App\\Listeners\\ActivityListener@emailedInvoice'), 'App\\Events\\InvoiceInvitationWasViewed' => array('App\\Listeners\\ActivityListener@viewedInvoice', 'App\\Listeners\\NotificationListener@viewedInvoice', 'App\\Listeners\\InvoiceListener@viewedInvoice'), 'App\\Events\\QuoteWasCreated' => array('App\\Listeners\\ActivityListener@createdQuote', 'App\\Listeners\\SubscriptionListener@createdQuote'), 'App\\Events\\QuoteWasUpdated' => array('App\\Listeners\\ActivityListener@updatedQuote'), 'App\\Events\\QuoteWasArchived' => array('App\\Listeners\\ActivityListener@archivedQuote'), 'App\\Events\\QuoteWasDeleted' => array('App\\Listeners\\ActivityListener@deletedQuote'), 'App\\Events\\QuoteWasRestored' => array('App\\Listeners\\ActivityListener@restoredQuote'), 'App\\Events\\QuoteWasEmailed' => array('App\\Listeners\\NotificationListener@emailedQuote'), 'App\\Events\\QuoteInvitationWasEmailed' => array('App\\Listeners\\ActivityListener@emailedQuote'), 'App\\Events\\QuoteInvitationWasViewed' => array('App\\Listeners\\ActivityListener@viewedQuote', 'App\\Listeners\\NotificationListener@viewedQuote', 'App\\Listeners\\QuoteListener@viewedQuote'), 'App\\Events\\QuoteInvitationWasApproved' => array('App\\Listeners\\ActivityListener@approvedQuote', 'App\\Listeners\\NotificationListener@approvedQuote'), 'App\\Events\\PaymentWasCreated' => array('App\\Listeners\\ActivityListener@createdPayment', 'App\\Listeners\\SubscriptionListener@createdPayment', 'App\\Listeners\\InvoiceListener@createdPayment', 'App\\Listeners\\NotificationListener@createdPayment'), 'App\\Events\\PaymentWasArchived' => array('App\\Listeners\\ActivityListener@archivedPayment'), 'App\\Events\\PaymentWasDeleted' => array('App\\Listeners\\ActivityListener@deletedPayment', 'App\\Listeners\\InvoiceListener@deletedPayment', 'App\\Listeners\\CreditListener@deletedPayment'), 'App\\Events\\PaymentWasRestored' => array('App\\Listeners\\ActivityListener@restoredPayment', 'App\\Listeners\\InvoiceListener@restoredPayment'), 'App\\Events\\CreditWasCreated' => array('App\\Listeners\\ActivityListener@createdCredit', 'App\\Listeners\\SubscriptionListener@createdCredit'), 'App\\Events\\CreditWasArchived' => array('App\\Listeners\\ActivityListener@archivedCredit'), 'App\\Events\\CreditWasDeleted' => array('App\\Listeners\\ActivityListener@deletedCredit'), 'App\\Events\\CreditWasRestored' => array('App\\Listeners\\ActivityListener@restoredCredit'), 'App\\Events\\UserSignedUp' => array('App\\Listeners\\HandleUserSignedUp'), 'App\\Events\\UserLoggedIn' => array('App\\Listeners\\HandleUserLoggedIn'), 'App\\Events\\UserSettingsChanged' => array('App\\Listeners\\HandleUserSettingsChanged'));
    public function boot(DispatcherContract $events)
    {
        parent::boot($events);
    }
