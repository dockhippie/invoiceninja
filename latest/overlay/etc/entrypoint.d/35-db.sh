...
[[ -z "${INVOICENINJA_REDIS_PASSWORD}" ]] && INVOICENINJA_REDIS_PASSWORD=""

declare -x INVOICENINJA_REDIS_PORT
[[ -z "${INVOICENINJA_REDIS_PORT}" ]] && INVOICENINJA_REDIS_PORT="6379"

declare -x INVOICENINJA_REDIS_DB
[[ -z "${INVOICENINJA_REDIS_DB}" ]] && INVOICENINJA_REDIS_DB="0"

declare -x INVOICENINJA_REDIS_CACHE_DB
[[ -z "${INVOICENINJA_REDIS_CACHE_DB}" ]] && INVOICENINJA_REDIS_CACHE_DB="1"

declare -x INVOICENINJA_REDIS_SENTINEL_SERVICE
[[ -z "${INVOICENINJA_REDIS_SENTINEL_SERVICE}" ]] && INVOICENINJA_REDIS_SENTINEL_SERVICE="mymaster"

declare -x INVOICENINJA_DB_CONNECTION
[[ -z "${INVOICENINJA_DB_CONNECTION}" ]] && INVOICENINJA_DB_CONNECTION="mysql"

declare -x INVOICENINJA_DB_WAIT_FOR_FAIL
[[ -z "${INVOICENINJA_DB_WAIT_FOR_FAIL}" ]] && INVOICENINJA_DB_WAIT_FOR_FAIL="true"
...
case "${INVOICENINJA_DB_CONNECTION}" in
    "mysql")
        ...
        [[ -z "${INVOICENINJA_DB_DATABASE}" ]] && INVOICENINJA_DB_DATABASE="invoiceninja"
    ...
    "postgres")
        ...
        [[ -z "${INVOICENINJA_DB_NAME}" ]] && INVOICENINJA_DB_NAME="invoiceninja"

        declare -x INVOICENINJA_DB_USERNAME
        [[ -z "${INVOICENINJA_DB_USERNAME}" ]] && INVOICENINJA_DB_USERNAME="postgres"

        declare -x INVOICENINJA_DB_PASSWORD
        [[ -z "${INVOICENINJA_DB_PASSWORD}" ]] && INVOICENINJA_DB_PASSWORD="postgres"
        ;;
esac
